 ...
 * 
 * Также нам потребует парсер для ESLint, который разрешит использовать современный синтаксис.
 * Пишем в консоли
 * 
 ...
 * Если у вас есть бесполезные переменные - не стесняйтесь их удалять.
 * 
